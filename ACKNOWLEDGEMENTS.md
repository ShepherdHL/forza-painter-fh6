<p align="center">
  ...
  <a href="FAQ.md">FAQ</a> ·
  <a href="ACKNOWLEDGEMENTS.md"><strong>Acknowledgements</strong></a> ·
...
| --- | --- | --- |
| the_adawg (AE) | [forza-painter/forza-painter](https://github.com/forza-painter/forza-painter) | Original Forza Painter: MIT-licensed FH import workflow, memory-writing/import foundation, and geometry-to-vinyl approach. |
...
| Person | Link |
| --- | --- |
| H3XDaemon | [github.com/H3XDaemon](https://github.com/H3XDaemon) |
| MaccLochlainn | [github.com/MaccLochlainn](https://github.com/MaccLochlainn) |
| ree9622 | [github.com/ree9622](https://github.com/ree9622) — Korean localization contributor in upstream history |

Full contributor list: [github.com/ShepherdHL/forza-painter-fh6/graphs/contributors](https://github.com/ShepherdHL/forza-painter-fh6/graphs/contributors)
