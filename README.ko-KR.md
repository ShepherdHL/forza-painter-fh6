...
1. [Releases](https://github.com/ShepherdHL/forza-painter-fh6/releases)에서 `forza-painter-fh6-v1.6.X.exe`를 다운로드합니다.
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="docs/screenshots/ImagePreview_Example.png" alt="이미지 미리보기"><br>
      <strong>이미지 미리보기</strong><br>
      <sub>생성 전에 전처리 필터(luma, 양방향, 포스터라이즈, 셀 셰이딩 등)를 비교합니다.</sub>
    </td>
    <td align="center" width="50%">
      <img src="docs/screenshots/GenerateJSON_Example.png" alt="JSON 생성"><br>
      <strong>JSON 생성</strong><br>
      <sub>이미지를 대기열에 추가하고 품질을 선택한 뒤 GPU 생성기를 실행합니다.</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <img src="docs/screenshots/TextVinyl_Example.png" alt="텍스트 비닐"><br>
      <strong>텍스트 비닐</strong><br>
      <sub>GB2312 문자 라이브러리와 시스템 글꼴로 CJK 입력, 또는 참조 이미지 추적.</sub>
    </td>
    <td align="center" width="50%">
      <img src="docs/screenshots/PixelArt_Example.png" alt="픽셀 아트"><br>
      <strong>픽셀 아트</strong><br>
      <sub>이미지를 FH6 도형 레이어로 변환하거나 내장 편집기에서 그립니다.</sub>
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2">
      <img src="docs/screenshots/ColorPicker_Example.png" alt="색상 선택기"><br>
      <strong>도구 → 색상 선택기</strong><br>
      <sub>이미지에서 색을 추출해 Forza H/S/B 값으로 변환합니다.</sub>
    </td>
  </tr>
</table>
